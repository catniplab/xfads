...
def main():
    ...
    for seed in seeds:
        ...
        seq_vae = LightningPendulum.load_from_checkpoint(ckpt_path, ssm=ssm, cfg=cfg,
                                                         n_time_bins_enc=n_time_bins_enc, strict=False)
        ...
        fig.savefig('plots/bouncing_ball_predictions_causal.pdf', bbox_inches='tight', transparent=True)
        fig.show()
