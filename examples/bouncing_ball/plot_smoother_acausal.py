...
def main():
    ...
    for seed in seeds:
        ...
        """lightning"""
        ckpt_path = "ckpts/smoother/acausal/epoch=1949_valid_loss=-4255.50_r2_valid_prd=0.30_r2_valid_enc=0.88.ckpt"
        ...
        y_s = seq_vae.ssm.likelihood_pdf.readout(z_s)
        y_p = seq_vae.ssm.likelihood_pdf.readout(z_p)
        ...
        fig.savefig(
            "plots/bouncing_ball_predictions_acausal.pdf",
            bbox_inches="tight",
            transparent=True,
        )
        fig.show()
