...
from xfads.smoothers.lightning_trainers import LightningBouncingBall
...
def main():
    ...
    for seed in seeds:
        ...
        test_dataloader = torch.utils.data.DataLoader(
            y_test_dataset, batch_size=cfg.batch_sz, shuffle=False
        )
        ...
        """lightning"""
        seq_vae = LightningBouncingBall(ssm, cfg, n_time_bins_enc)
        csv_logger = CSVLogger(
            "logs/smoother/causal/",
        ...
        ckpt_callback = ModelCheckpoint(
            ...
            mode="max",
            dirpath="ckpts/smoother/causal/",
            filename="{epoch:0}_{valid_loss:0.2f}_{r2_valid_prd:0.2f}_{r2_valid_enc:0.2f}",
        )
        ...
        torch.save(
            ckpt_callback.best_model_path, "ckpts/smoother/causal/best_model_path.pt"
        )
