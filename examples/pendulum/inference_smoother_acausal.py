...
def main():
    ...
    for seed in seeds:
        ...
        valid_dataloader = torch.utils.data.DataLoader(y_valid_dataset, batch_size=cfg.batch_sz, shuffle=False)
        ...
        torch.save(ckpt_callback.best_model_path,f'ckpts/smoother/acausal/sd_{cfg.seed}_best_model_path.pt')
