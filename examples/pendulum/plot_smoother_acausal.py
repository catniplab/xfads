...
def main():
    ...
    for seed in seeds:
        ...
        seq_vae = LightningPendulum.load_from_checkpoint(
            "ckpts/smoother/acausal/epoch=1699_valid_mse=0.07_r2_valid_prd=0.50_r2_valid_enc=0.98_valid_loss=-567.85.ckpt",
            ssm=ssm,
            cfg=cfg,
            n_time_bins_enc=n_time_bins_enc,
            strict=False,
        )
        _, z_s, stats_s = seq_vae.ssm(y_test[:, :n_time_bins_enc], cfg.n_samples)
        ...
        fig.savefig(
            "plots/pendulum_predictions_acausal.pdf",
            bbox_inches="tight",
            transparent=True,
        )
        fig.show()
